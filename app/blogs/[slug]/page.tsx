  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-background">
        ...
        <div className="relative w-full h-[300px] md:h-[500px] overflow-hidden mb-8">
          <Image
            src={blog.cover_image || "https://qqthjpwwhdtxkwoxpqwu.supabase.co/storage/v1/object/public/cms-uploads/1764620776095-x0ygkvaqfao.png"}
            alt={blog.title}
            fill
