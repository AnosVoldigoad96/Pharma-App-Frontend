            ...
            <div className="max-w-3xl mx-auto px-4 relative z-10">
                <Card className="bg-background/40 backdrop-blur-xl border-primary/20 shadow-2xl overflow-hidden">
                    ...
                    <CardHeader className="text-center pb-8">
                        ...
                        <CardTitle className="text-2xl md:text-3xl font-bold">Request a Tool</CardTitle>
                        <CardDescription className="text-lg mt-2 max-w-lg mx-auto">
                            Need a specific calculation or utility? Let us know and we'll build it for you.
                        </CardDescription>
                    </CardHeader>
                        ...
                        {user ? (
                            success ? (
                                <div className="flex flex-col items-center justify-center py-12 text-center animate-in fade-in zoom-in duration-300">
                                    ...
                                    <p className="text-muted-foreground max-w-md">
                                        Thank you for your suggestion. We'll review your request and notify you if we develop this tool.
                                    </p>
                                    <Button
                                        variant="outline"
                                        className="mt-6"
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4 max-w-lg mx-auto">
                                    <div className="space-y-2">
                                        <label htmlFor="title" className="text-sm font-medium">Tool Name <span className="text-red-500">*</span></label>
                                        <Input
                                            id="title"
                                            placeholder="e.g. Creatinine Clearance Calculator"
                                            value={title}
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Textarea
                                            id="description"
                                            placeholder="Describe what the tool should do, inputs needed, and expected outputs..."
                                            value={description}
                            ...
                            <div className="text-center py-8">
                                <p className="text-muted-foreground mb-6">
                                    You must be signed in to submit tool requests.
                                </p>
