...
export function ThreadCreationHero() {
    ...
    return (
        <section className="relative min-h-[300px] md:min-h-[400px] flex items-center justify-center overflow-hidden mb-8">
            ...
            <div className="max-w-4xl mx-auto px-4 w-full relative z-20 text-center pt-10 pb-20">
                ...
                >
                    ...
                    <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto leading-relaxed drop-shadow-md font-light">
                        Engage with the community, ask questions, and share insights.
                    </p>
                </motion.div>
            </div>
        </section>
