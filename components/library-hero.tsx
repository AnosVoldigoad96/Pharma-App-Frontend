...
export function LibraryHero({ heading, subtitle }: LibraryHeroProps) {
    ...
    return (
        <section className="relative h-[300px] md:h-[500px] flex items-center overflow-hidden">
            {/* Background */}
          ...
          `,
            ...
            <div className="max-w-7xl mx-auto px-4 w-full relative z-20 text-center">
                ...
                >
                    <h1 className="text-xl md:text-6xl font-bold mb-2 md:mb-6 leading-tight text-white drop-shadow-lg line-clamp-2">
                        {heading}
                    </h1>
                    ...
                    >
                        <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/20 backdrop-blur-sm">
                            ...
                            <span className="text-sm text-emerald-200">Vast Collection</span>
                        </div>
                        <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-teal-500/10 border border-teal-500/20 backdrop-blur-sm">
                            ...
                            <span className="text-sm text-teal-200">Digital Access</span>
                        </div>
                        <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/20 backdrop-blur-sm">
                            ...
                            <span className="text-sm text-cyan-200">Curated Content</span>
                        </div>
                    </motion.div>
                </motion.div>
            </div>
